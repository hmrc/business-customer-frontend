...
class ReviewDetailsControllerSpec extends PlaySpec with GuiceOneServerPerSuite with MockitoSugar with BeforeAndAfterEach {
  ...
  val directMatchReviewDetails = ReviewDetails("ACME", "Limited", address, "sap123", "safe123", isAGroup = false, directMatch = true, Some("agent123"))

  val nonDirectMatchReviewDetails = ReviewDetails("ACME", "Limited", address, "sap123", "safe123", isAGroup = false, directMatch = false, Some("agent123"))
