...
class BusinessMatchingServiceSpec extends PlaySpec with GuiceOneServerPerSuite with MockitoSugar with BeforeAndAfterEach {
  ...
  val successOrgReviewDetailsDirect = ReviewDetails(
    "Real Business Inc",
    Some("unincorporated body"),
    testAddress,
    "1234567890",
    "EX0012345678909",
    isAGroup = true,
  ...
  val successOrgReviewDetails = ReviewDetails(
    "Real Business Inc",
    Some("unincorporated body"),
    testAddress,
    "1234567890",
  ...
  val successIndReviewDetailsDirect = ReviewDetails(
  ...
  val successIndReviewDetails = ReviewDetails(
    "first name last name",
    Some("Sole Trader"),
    testAddress,
    "1234567890",
  ...
  object TestBusinessMatchingService
      extends BusinessMatchingService(
  ...
  "BusinessMatchingService" must {
    ...
    "matchBusinessWithUTR" must {
      ...
      "for match found with SA user, return Review details as JsValue" in {
        ...
        when(
          mockBusinessMatchingConnector.lookup(ArgumentMatchers.any(), ArgumentMatchers.any(), ArgumentMatchers.any())(
        ...
        when(mockDataCacheConnector.saveReviewDetails(ArgumentMatchers.any())(ArgumentMatchers.any(), ArgumentMatchers.any()))
          .thenReturn(Future.successful(Some(testReviewDetails)))
        ...
        verify(mockBusinessMatchingConnector, times(1)).lookup(ArgumentMatchers.any(), ArgumentMatchers.any(), ArgumentMatchers.any())(
          ArgumentMatchers.any(),
          ArgumentMatchers.any(),
          ArgumentMatchers.any())
        verify(mockDataCacheConnector, times(1)).saveReviewDetails(ArgumentMatchers.any())(ArgumentMatchers.any(), ArgumentMatchers.any())
      }
      ...
      "for match Not found with SA user, return Reasons as JsValue" in {
        ...
        verify(mockBusinessMatchingConnector, times(1)).lookup(ArgumentMatchers.any(), ArgumentMatchers.any(), ArgumentMatchers.any())(
          ...
          ArgumentMatchers.any(),
          ArgumentMatchers.any())
        verify(mockDataCacheConnector, times(0)).saveReviewDetails(ArgumentMatchers.any())(ArgumentMatchers.any(), ArgumentMatchers.any())
      }
      ...
      "for ORG user, return None as JsValue" in {
        ...
        val result                                 = TestBusinessMatchingService.matchBusinessWithUTR(false, service)
        result must be(None)
        verify(mockBusinessMatchingConnector, times(0)).lookup(ArgumentMatchers.any(), ArgumentMatchers.any(), ArgumentMatchers.any())(
          ArgumentMatchers.any(),
          ArgumentMatchers.any(),
          ArgumentMatchers.any())
        verify(mockDataCacheConnector, times(0)).saveReviewDetails(ArgumentMatchers.any())(ArgumentMatchers.any(), ArgumentMatchers.any())
