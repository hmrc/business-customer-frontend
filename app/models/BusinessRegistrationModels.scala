...
case class OverseasCompanyDisplayDetails(title: String, header: String, subHeader: String, addClient: Boolean)
...
case class Address(line_1: String, line_2: String, line_3: Option[String], line_4: Option[String], postcode: Option[String] = None, country: String) {
