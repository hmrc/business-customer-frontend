...
class NewBusinessCustomerConnector @Inject() (config: ApplicationConfig, val audit: Auditable, val http: HttpClientV2)
  ...
  def addKnownFacts(knownFacts: Verifiers, arn: String)(implicit
