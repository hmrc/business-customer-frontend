...
object BusinessVerificationForms extends BCUtils {
    ...
    (businessType.nonEmpty, businessType.getOrElse(""), isSaAccount, isOrgAccount) match {
      case (true, "SOP", false, true) =>
        service match {
          ...
          case _ => businessTypeData.withError(key = "businessType", message = "bc.business-verification-error.type_of_business_organisation_invalid")
        }
  ...
  val businessTypeForm: Form[BusinessType] = Form(
    mapping(
  ...
  val soleTraderForm: Form[SoleTraderMatch] = Form(
    mapping(
      "firstName" -> text
      ...
      "saUTR" -> text
        ...
        .verifying(
          "bc.business-verification-error.sautr.length",
          x => {
        ...
        .verifying(
          "bc.business-verification-error.invalidSAUTR",
          x => {
            val trimmedString = x.replaceAll(" ", "")
  ...
  val limitedCompanyForm: Form[LimitedCompanyMatch] = Form(
    mapping(
      "businessName" -> text
      ...
      "cotaxUTR" -> text
        ...
        .verifying(
          "bc.business-verification-error.cotaxutr.length",
          x => {
            val trimmedString = x.replaceAll(" ", "")
            trimmedString.isEmpty || (trimmedString.nonEmpty && trimmedString.matches("""^[0-9]{10}$"""))
          }
        ...
        .verifying(
          "bc.business-verification-error.invalidCOUTR",
          x => {
            val trimmedString = x.replaceAll(" ", "")
            trimmedString.isEmpty || (validateUTR(trimmedString) || !trimmedString.matches("""^[0-9]{10}$"""))
          }
  ...
  val nonResidentLandlordForm: Form[NonResidentLandlordMatch] = Form(
    mapping(
      "businessName" -> text
        .verifying("bc.business-verification-error.businessName", x => x.trim.length > length0)
        .verifying("bc.business-verification-error.registeredName.length", x => x.isEmpty || (x.nonEmpty && x.length <= length105)),
  ...
  val unincorporatedBodyForm: Form[UnincorporatedMatch] = Form(
    mapping(
      "businessName" -> text
        .verifying("bc.business-verification-error.businessName", x => x.trim.length > length0)
        .verifying("bc.business-verification-error.registeredName.length", x => x.isEmpty || (x.nonEmpty && x.length <= length105)),
  ...
  val ordinaryBusinessPartnershipForm: Form[OrdinaryBusinessPartnershipMatch] = Form(
    mapping(
      "businessName" -> text
      ...
      "psaUTR" -> text
        ...
        .verifying(
          "bc.business-verification-error.psautr.length",
          x => {
            val trimmedString = x.replaceAll(" ", "")
            trimmedString.isEmpty || (trimmedString.nonEmpty && trimmedString.matches("""^[0-9]{10}$"""))
          }
        ...
        .verifying(
          "bc.business-verification-error.invalidPSAUTR",
          x => {
            val trimmedString = x.replaceAll(" ", "")
            trimmedString.isEmpty || (validateUTR(trimmedString) || !trimmedString.matches("""^[0-9]{10}$"""))
          }
  ...
  val limitedLiabilityPartnershipForm: Form[LimitedLiabilityPartnershipMatch] = Form(
    mapping(
      "businessName" -> text
        .verifying("bc.business-verification-error.businessName", x => x.trim.length > length0)
        .verifying("bc.business-verification-error.registeredName.length", x => x.isEmpty || (x.nonEmpty && x.length <= length105)),
  ...
  val limitedPartnershipForm: Form[LimitedPartnershipMatch] = Form(
    mapping(
      "businessName" -> text
        .verifying("bc.business-verification-error.businessPartnerName", x => x.trim.length > length0)
        .verifying("bc.business-verification-error.registeredPartnerName.length", x => x.isEmpty || (x.nonEmpty && x.length <= length105)),
